...
insert into preferences (id, description, is_active, field_id) values (38, "Cannot resist to speak up when there is a problem", true, 3) on duplicate key update id = 38;
...
insert into professions_activities(profession_id, activities_id) values (8, 33) on duplicate key update profession_id=8, activities_id =33;
insert into professions_activities(profession_id, activities_id) values (8, 34) on duplicate key update profession_id=8, activities_id =34;
insert into professions_activities(profession_id, activities_id) values (8, 35) on duplicate key update profession_id=8, activities_id =35;
insert into professions_activities(profession_id, activities_id) values (8, 36) on duplicate key update profession_id=8, activities_id =36;
insert into professions_activities(profession_id, activities_id) values (8, 37) on duplicate key update profession_id=8, activities_id =37;
insert into professions_activities(profession_id, activities_id) values (5, 38) on duplicate key update profession_id=5, activities_id =38;
...
insert into professions_traits(profession_id, traits_id) values (4, 2) on duplicate key update profession_id = 4, traits_id = 2;
...
insert into professions_traits(profession_id, traits_id) values (7, 7) on duplicate key update profession_id = 7, traits_id = 7;
insert into professions_traits(profession_id, traits_id) values (7, 5) on duplicate key update profession_id = 7, traits_id = 5;
