...
import com.sbnz.career.adviser.model.User;
...
public class Application {
	...
	public static void findCandidateProfessions() {
		KieServices ks = KieServices.Factory.get();
		KieContainer kContainer = ks
				.newKieContainer(ks.newReleaseId("sbnz.integracija", "drools-spring-kjar", "0.0.1-SNAPSHOT"));
		KieScanner kScanner = ks.newKieScanner(kContainer);
		...
		User user = new User(1L, "Marina", "Vojnovic", "marina.vojnovic1997@gmail.com");
		TraitsResult traitsResult = new TraitsResult(1L, 20, 10, 15, 10, 40, 30, 20, 13, 10, 9);
		...
		*/
		...
		traits1.add(new Trait("mind", "introverted"));
		...
		PreferenceQuestionResult prefQuestResult1 = new PreferenceQuestionResult(1l, 1l, act1, false);
		...
		ProfessionsSuitabilityList suitableProfessions = new ProfessionsSuitabilityList();
		kieSession.insert(suitableProfessions);
		kieSession.getAgenda().getAgendaGroup("suitableProfessionsTest-preferences").setFocus();
		kieSession.fireAllRules();
		
		System.out.println(suitableProfessions.getSuitableProfessions().size());
	...
	public static void matchingTest() {
		...
		kieSession.insert(prof1);
			...
			/*
		List<PreferenceQuestionResult> userPreferences = new ArrayList<PreferenceQuestionResult>();
		userPreferences.add(prefQuestResult1);
		userPreferences.add(prefQuestResult2);
		userPreferences.add(prefQuestResult3);
		userPreferences.add(prefQuestResult4);
		userPreferences.add(prefQuestResult5);
		userPreferences.add(prefQuestResult21);
		userPreferences.add(prefQuestResult22);
		userPreferences.add(prefQuestResult222);
		*/
